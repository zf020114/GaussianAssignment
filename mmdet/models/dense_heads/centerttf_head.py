...
from mmcv.cnn import bias_init_with_prob, normal_init, ConvModule, kaiming_init
...
class CenterTTFHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        super(CenterTTFHead, self).__init__(init_cfg)

...
model = dict(
    ...
    train_cfg=None,
    test_cfg=dict(topk=200, local_maximum_kernel=3, max_per_img=200))
...
load_from =None#'/media/zf/E/checkpoint/vfnet_r50_dcn_ms_2x_47.8.pth'
resume_from = './workdir/centernet_r50_2x_800_aitod/latest.pth'
work_dir = './workdir/centernet_r50_2x_800_aitod'